...
adb shell pm disable-user --user 0 com.xiaomi.o2o
adb shell pm disable-user --user 0 com.xiaomi.vipaccount
adb shell pm disable-user --user 0 com.xiaomi.lens
adb shell pm disable-user --user 0 com.xiaomi.pass
adb shell pm disable-user --user 0 com.miui.systemAdSolution
adb shell pm disable-user --user 0 com.baidu.input_mi
